    ...
    <div class="container mt-5">
        <div class="card shadow">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('categories.create') }}" class="btn btn-light btn-sm fw-bold">+ Add Category</a>
                    <a href="{{ route('books.index') }}" class="btn btn-outline-light btn-sm fw-bold ms-2">📚 Books List</a>
                </div>
            </div>
            <div class="card-body">
                @if(session('success'))
